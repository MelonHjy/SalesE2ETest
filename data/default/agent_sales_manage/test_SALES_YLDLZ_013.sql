...
delete from sadqualify where usercode = '83258491';
...
delete from saucontract where usercode = '83258491';
delete from sadaccount where accountid=1000000001354474;
delete from sauuserrank where usercode = '83258491';
delete from sauuserrankhis where usercode = '83258491';
delete from SaUContractHis where usercode =  '83258491';
delete from sadqualifyhis where usercode = '83258491';
delete from prpdsellernohis where  sellercode = '83258491';

--1、清理数据并准备数据
--step1.删除sauuser和sauusersub表数据并插入准备数据
delete from sauuser where usercode ='83258491';
...
delete from sauusersub where userid ='1000000002297685';
...
delete from prpdsellerno  where sellercode = '83258491';
...
delete from saugroupjobhistory where usercode = '83258491';

--step6团队职位表删除并插入
delete from saugroupjob where usercode = '83258491';
...
--step10.删除人员修改历史表数据
delete from sauuserhistory where usercode = '83258491';
